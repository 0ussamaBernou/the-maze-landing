    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div
                ...
                <h1 class="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">The Maze with 3d raycasting</h1>
        ...
        Get ready to immerse yourself in "The Maze," a thrilling 3D maze game that will challenge your navigation skills and keep you on the edge of your seat. Built using C and SDL2, with stunning graphics powered by raycasting, "The Maze" offers a unique gaming experience that combines retro charm with modern performance.
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Challenging Mazes</h2>
                    <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Navigate through increasingly complex mazes that will test your spatial awareness and problem-solving skills.</p>
                    <a href="#"
                ...
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Built with C & SDL2</h2>
...
<script>
export default {
    name: 'MazeGameLandingPage',
    data() {
        return {
            features: [
                {
                    title: '3D Raycasting',
                    description: 'Experience smooth, realistic 3D graphics powered by raycasting technology.'
                },
                {
                    title: 'Challenging Mazes',
                    description: 'Navigate through increasingly complex mazes that will test your spatial awareness and problem-solving skills.'
                },
                {
                    title: 'Built with C & SDL2',
                    description: 'Enjoy optimal performance and cross-platform compatibility thanks to our efficient C and SDL2 implementation.'
                }
            ]
        }
    }
